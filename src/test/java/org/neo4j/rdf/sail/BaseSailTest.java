...
public abstract class BaseSailTest
{
            ...
            IndexService indexService )
    {
        ...
        clearFulltextIndex();
        return new VerboseQuadStore( graphDb, indexService, null, fulltextIndex );
    }
    ...
    public void testBasic() throws Exception
    {
        ...
        try
        {
            ...
            waitForFulltextIndex();
            assertEquals( countBefore,
                    countStatements( sc.evaluate( "Yoichiro" ) ) );
            evaluateFreetextQuery( "Yoichiro", sc );
        }
        finally
        {
    ...
    public void testFulltextSearch() throws Exception
    {
        ...
        try
        {
            ...
            count = countStatements( ( (GraphDatabaseSailConnection) sc ).evaluate( "Lorem ipsum" ) );
            assertEquals( 2, count );
            count = countStatements( ( (GraphDatabaseSailConnection) sc ).evaluate( "dolo*" ) );
            assertEquals( 2, count );
            count = countStatements( ( (GraphDatabaseSailConnection) sc ).evaluate( "aliq* integer" ) );
            assertEquals( 2, count );
    ...
    public void testMetadata() throws Exception
    {
        ...
        try
        {
            ...
            count = countStatements( sc.getStatements( uriA, uriB, uriC,
                    includeInferred ) );
            assertEquals( 1, count );
            CloseableIteration<? extends Statement, SailException> itr = sc.getStatements(
                    uriA, uriB, uriC, includeInferred );
    ...
    public void testAddWithMetadata() throws Exception
    {
        ...
        try
        {
            ...
            Statement statement = sc.addStatement( metadata, uriA, uriB, uriC,
                    contextA );
            GraphDatabaseStatement graphDbRdfStatement = (GraphDatabaseStatement) statement;
            assertEquals( valueA, graphDbRdfStatement.getMetadata().get(
                    metadataKey ) );
            ...
            graphDbRdfStatement = (GraphDatabaseStatement) statement;
            assertEquals( valueB, graphDbRdfStatement.getMetadata().get(
                    metadataKey ) );
            graphDbRdfStatement = (GraphDatabaseStatement) sc.getStatements(
                    uriA, uriB, uriC, includeInferred, contextA ).next();
            assertEquals( valueA, graphDbRdfStatement.getMetadata().get(
                    metadataKey ) );
            graphDbRdfStatement = (GraphDatabaseStatement) sc.getStatements(
                    uriA, uriB, uriC, includeInferred, contextB ).next();
            assertEquals( valueB, graphDbRdfStatement.getMetadata().get(
                    metadataKey ) );
    ...
    private int countStatements( CloseableIteration<?, SailException> statements )
